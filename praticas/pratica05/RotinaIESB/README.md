...
App organizador simples da rotina acadêmica do aluno no IESB — Atividade
Integradora (Aulas 02 a 06), disciplina Programação para Dispositivos
Móveis (React Native / Expo).
...
## 4) Arquivos criados em `components/` e `labels.js`
